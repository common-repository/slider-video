                        ...
                        var IdealImageSlider = (function() {
                            ...
                            var Slider = function(args) {
                                ...
                                this.settings = {
                                    ...
                                    initialHeight: Math.floor(jQuery("#RW_Load_SVS_Navigation<?php echo esc_html($Rich_Web_VSlider_ID); ?>").width()*56.25/100-<?php echo  esc_js($Rich_Web_VSlider_Eff[0]->Rich_Web_SVS_BW);?>), // for "auto" and aspect ratio
                                    maxHeight: null, // for "auto" and aspect ratio
                                    interval: <?php echo  esc_js($Rich_Web_VSlider_Eff[0]->Rich_Web_SVS_PT*1000);?>,
                                    transitionDuration: <?php echo  esc_js($Rich_Web_VSlider_Eff[0]->Rich_Web_SVS_CS);?>,
                                    effect: '<?php echo  esc_js($Rich_Web_VSlider_Eff[0]->Rich_Web_SVS_Eff);?>',
                                    disableNav: <?php if($Rich_Web_VSlider_Eff[0]->Rich_Web_SVS_Arr_Show=='on'){ echo 'false';}else{ echo 'true';}?>,
                                    keyboardNav: true,
                                    previousNavSelector: '.Rich_Web_SVS_Prev_<?php echo  esc_js($Rich_Web_Video);?>',
                                    nextNavSelector: '.Rich_Web_SVS_Next_<?php echo  esc_js($Rich_Web_Video);?>',
                                    classes: {
...
(function(IIS) {
	...
	//-->
                    ...
                    <script>
                        var slider = new IdealImageSlider.Slider('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>');
                        slider.addCaptions();
                        slider.addBulletNav();
                        slider.start();
                    </script>
                    <script>
                        jQuery(document).ready(function(){
                            var RichVSTitle = jQuery('.RichVSTitle<?php echo esc_html($Rich_Web_VSlider_ID); ?>').val();
                            function resp(){
                                jQuery("#RW_Load_SVS_Navigation<?php echo esc_html($Rich_Web_VSlider_ID); ?>").css("max-height",Math.floor(jQuery("#RW_Load_SVS_Navigation<?php echo esc_html($Rich_Web_VSlider_ID); ?>").width()*56.25/100));
                                jQuery('.Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').css('max-height',jQuery('.Rich_Web_VS_SVS').height());
                                jQuery('.iis-caption .iis-caption-content span').css('font-size',Math.floor(RichVSTitle*jQuery('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').width()/(jQuery('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').width()+150))+'px');
                                ...
                                jQuery('.Rich_Web_VSlider_SVS_PlayIcon').css('height',Math.floor(jQuery('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').height()/8));
                                jQuery('.Rich_Web_VSlider_SVS_PlayIcon span').css('width',Math.floor(jQuery('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').width()/8));
                                jQuery('.Rich_Web_VSlider_SVS_PlayIcon span').css('line-height',Math.floor(jQuery('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').height()/8)-1+'px');
                                jQuery('.Rich_Web_VSlider_SVS_PlayIcon span i').css('line-height',Math.floor(jQuery('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').height()/8)-1+'px');
                                ...
                                jQuery('.Rich_Web_SVS_Nav').css('font-size',Math.floor(30*jQuery('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').width()/700));
                                jQuery('.Rich_Web_SVS_Nav').css('padding',Math.floor(10*jQuery('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').width()/700)+'px '+Math.floor(15*jQuery('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').width()/700)+'px');
                                if(jQuery('#Rich_Web_VS_SVS_<?php echo  esc_js($Rich_Web_Video);?>').width()<=400)
                                {
                            ...
                            var array_svs<?php echo esc_html($Rich_Web_VSlider_ID); ?>=[];
                            jQuery(".img_simple<?php echo  esc_js($Rich_Web_Video);?>").each(function(){
                                if( jQuery(this).attr("src") != "" ) {
                                    array_svs<?php echo esc_html($Rich_Web_VSlider_ID); ?>.push(jQuery(this).attr("src"));
                                }
                            })
                            var y_svs<?php echo esc_html($Rich_Web_VSlider_ID); ?>=0;
                            for(i=0;i<array_svs<?php echo esc_html($Rich_Web_VSlider_ID); ?>.length;i++){
                                jQuery("<img class='img_simple<?php echo  esc_js($Rich_Web_Video);?>' />").attr('src', array_svs<?php echo esc_html($Rich_Web_VSlider_ID); ?>[i]).on("load",function(){
                                    y_svs<?php echo esc_html($Rich_Web_VSlider_ID); ?>++;
                                    if(y_svs<?php echo esc_html($Rich_Web_VSlider_ID); ?> == array_svs<?php echo esc_html($Rich_Web_VSlider_ID); ?>.length){
                                        jQuery(".RichWeb_SVS_<?php echo  esc_js($Rich_Web_Video);?>").fadeIn(1000);
                                        jQuery("#RW_Load_SVS_Navigation<?php echo esc_html($Rich_Web_VSlider_ID); ?>").remove();
                                    }
                                })
                            }
                        })
